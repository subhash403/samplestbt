...
def HDAT_setting(value):
	token = get_auth_token()
	if value == "Off":
		newAcctJson ='{"settings":{"groups":[{"id":"STB00000492DBAD","type":"device-stb","options":[{"name":"HD Auto Tune","value":["Off"]}]}]}}'
	elif value == "On":
		newAcctJson ='{"settings":{"groups":[{"id":"STB00000492DBAD","type":"device-stb","options":[{"name":"HD Auto Tune","value":["On"]}]}]}}'
...
def GNarration_setting(value):
	token = get_auth_token()
	if value == "Off":
		newAcctJson ='{"settings":{"groups":[{"id":"STB00000492DBAD","type":"device-stb","options":[{"name":"Guide Narration","value":["Off"]}]}]}}'
	elif value == "On":
		newAcctJson ='{"settings":{"groups":[{"id":"STB00000492DBAD","type":"device-stb","options":[{"name":"Guide Narration","value":["On"]}]}]}}'
	url = "http://spectrum.engprod-charter.net/api/pub/networksettingsedge/v1/settings"
	headers={'X-CHARTER-SESSION':token, 'Content-Type':'application/json'}
	req = requests.post(url, data=newAcctJson, auth=('charternet', 'Chart3rn3t'),headers=headers)
	print req
