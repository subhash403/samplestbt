...
def test_tc_958_LiveTV_021_InfoBanner_AutoDismiss():
    ...
    def info_banner(step_name, Tester):
        Tester.remote_control_press_until_image_match('KEY_DOWN', preferencesscreen.infobanner["image"], maximum_key_press=7,region=preferencesscreen.infobanner["region"])
        Tester.remote_control_press('KEY_ENTER', 0)
